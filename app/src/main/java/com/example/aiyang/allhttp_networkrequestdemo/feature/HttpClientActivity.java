...
public class HttpClientActivity extends TopBarBaseActivity{
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        send_button2= (Button) findViewById(R.id.send_button2);
    ...
    private void sendRequestGet(final int a){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                HttpGet httpGet;
                if (a==1)
                    httpGet = new HttpGet("http://192.168.43.220/gpio/1");
                    else
                    httpGet = new HttpGet("http://192.168.43.220/gpio/0");
